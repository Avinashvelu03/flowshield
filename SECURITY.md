...
- **GitHub Security Advisories**: [Report here](https://github.com/Avinashvelu03/flowshield/security/advisories/new)
...
- Always pin to a specific version in production: `"flowshield": "1.0.3"`
